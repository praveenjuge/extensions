import { ActionPanel, Action, Detail, Icon, Toast } from "@raycast/api";
        ...
        <ActionPanel>
          ...
          <ActionPanel.Section title="Custom actions">
            <Action
              ...
              onAction={() => Toast.show(Toast.Style.Success, "Performed custom action")}
            />
...
function ReusableAction(props: { title: string; icon?: Icon }) {
  return (
    <Action
      ...
      onAction={() => Toast.showHUD(props.title)}
    />
  );
}
